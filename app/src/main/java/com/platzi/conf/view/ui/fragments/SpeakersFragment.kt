...
class SpeakersFragment(override var layoutManager: GridLayoutManager) : Fragment(), SpeakerListener {
    ...
    fun observeViewModel() {
        ...
        viewModel.isLoading.observe(this, Observer<Boolean>{
            if(it != null) {
                R.id.rlBase.visibility = view.INVISIBLE
            }
        })
    }
