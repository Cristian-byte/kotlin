...
import com.platzi.conf.R.id.*
import com.platzi.conf.R.id.ToolbarConference
import com.platzi.conf.R.id.tvDetailConferenceDescription
import com.platzi.conf.R.id.tvDetailConferenceHour
import com.platzi.conf.R.id.tvDetailConferenceSpeaker
import com.platzi.conf.R.id.tvDetailConferenceTag
...
class ScheduleDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val pattern = "ss/MM/yyyy hh:mm a"
